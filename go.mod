module github.com/cloud-gov/bosh-deployment-resource
...
require (
	...
	github.com/cloudfoundry/bosh-gcscli v0.0.266 // indirect
	github.com/cloudfoundry/bosh-s3cli v0.0.337 // indirect
